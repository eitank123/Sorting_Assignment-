        ...
        for size in sizes:
            ...
            for alg_id in selected_ids:
                ...
                if name == "Insertion Sort":
                    if noise == 0 and size > 25000:  # 100% Random
                        continue
                    elif noise == 20 and size > 50000:  # 20% Noise
                        continue
                    elif noise == 5 and size > 100000:  # 5% Noise
                        continue
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs='+',
        type=int,
        default=[100, 1000, 5000, 10000, 25000, 50000, 250000, 1000000]
    )
